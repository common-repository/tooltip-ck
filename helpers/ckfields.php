...
class CKFields {
	...
	*/
	public function load_assets_files() {
		wp_enqueue_media();
//		wp_enqueue_script('tooltip-ck-media', $this->pluginurl . '/fields/media.js', array('jquery'));
	}

	public function render($type, $name, $value = null, $optionsgroup = 'boolean', $classname = '',  $isfiles = false, $attribs = '') {
